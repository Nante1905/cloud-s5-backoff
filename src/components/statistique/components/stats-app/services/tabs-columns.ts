...
import { GridCellParams, GridColDef, GridTreeNode, GridValueGetterParams } from "@mui/x-data-grid";
...
export const statsTopUtilisateurColumns: GridColDef[] = [
    ...
    },
    {
        ...
        minWidth: 150,
        align: "right",
        cellClassName: (params: GridCellParams<any, any, any, GridTreeNode>) => 'big strong',
        valueGetter: (params: GridValueGetterParams) =>
